              ...
              actions: [
                GhostButton(
                  ...
                  onPressed: () {
                    // open in new tab
                    String url =
                        'https://github.com/ArcaneArts/arcane/blob/master/docs/${widget.path}';
          ...
          return CodeSnippet(
            ...
            actions: [
              GhostButton(
                ...
                onPressed: () {
                  // open in new tab
                  //https://github.com/ArcaneArts/arcane/blob/master/docs/lib/pages/docs/layout_page/layout_page_example_1.dart
                  String url =
                      'https://github.com/ArcaneArts/arcane/blob/master/docs/${widget.path}';
                  // html.window.open(url, 'blank');
                  launchUrlString(url);
