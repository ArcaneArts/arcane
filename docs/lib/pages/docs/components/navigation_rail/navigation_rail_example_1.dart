      ...
      child: Row(
        ...
        children: [
          NavigationRail(
            ...
            children: [
              buildButton('Home', Icons.house),
              buildButton('Explore', Icons.compass),
              buildButton('Library', Icons.music_notes),
              const NavigationDivider(),
              const NavigationLabel(child: Text('Settings')),
              buildButton('Profile', Icons.person),
              buildButton('App', Icons.app_store_logo),
              const NavigationDivider(),
