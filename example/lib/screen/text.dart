...
class ExampleText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Screen.expander(
      collapsedHeader: Bar(
        titleText: "Collapsed Header",
      ),
      expandedHeader:
          Bar(titleText: "Expanded Header", subtitleText: "Some Subtitle Text"),
      sliver: SListView(
        children: [
          const Divider(
            height: 16,
...
class ExampleTextOld extends StatelessWidget {
  const ExampleTextOld({super.key});
