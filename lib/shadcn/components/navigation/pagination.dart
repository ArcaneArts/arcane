  ...
  Widget _buildPreviousLabel(ShadcnLocalizations localizations) {
    if (showLabel) {
      return GhostButton(
        ...
        leading: const Icon(Icons.chevron_back_ionic).iconXSmall(),
        child: Text(localizations.buttonPrevious),
      );
    }
    return GhostButton(
      onPressed: hasPrevious ? () => onPageChanged(page - 1) : null,
      child: const Icon(Icons.chevron_back_ionic).iconXSmall(),
    );
  }
  ...
  Widget _buildNextLabel(ShadcnLocalizations localizations) {
    if (showLabel) {
      return GhostButton(
        ...
        trailing: const Icon(Icons.chevron_forward_ionic).iconXSmall(),
        child: Text(localizations.buttonNext),
      );
    }
    return GhostButton(
      onPressed: hasNext ? () => onPageChanged(page + 1) : null,
      child: const Icon(Icons.chevron_forward_ionic).iconXSmall(),
    );
  }
