...
///
class ArcaneGrid<E extends Object> extends StatefulWidget {
  /// The current list of items that this[ArcaneGrid] should represent.
  final List<E> items;
  ...
  /// context.
  ///
  /// If no [ArcaneGridState] surrounds the given context, then this function
  ...
  /// context.
  ///
  /// This method is typically used by [ArcaneGridState] item widgets that insert
  /// or remove items in response to user input.
  ///
  /// If no [ArcaneGridState] surrounds the context given, then this function will
  /// return null.
  ///
  /// This method can be expensive (it walks the element tree).
  static ArcaneGridState? maybeOf(BuildContext context) {
    return context.findAncestorStateOfType<ArcaneGridState>();
  }

  @override
  State<ArcaneGrid<E>> createState() => ArcaneGridState();
}

class ArcaneGridState<E extends Object> extends State<ArcaneGrid<E>> {
  @override
